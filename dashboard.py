...
# ─── Vertex AI Prediction 클라이언트 초기화 ─────────────────
...
def summarize_pdf_bytes(pdf_bytes: bytes) -> str:
    ...
    prompt = "다음 PDF 내용을 3줄 이내로 요약해 주세요:\n\n" + text
    try:
        return summarize_with_text_bison(prompt)
